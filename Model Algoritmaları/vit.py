...
# Daha küçük bir ViT modeli yükleme
model = ViTForImageClassification.from_pretrained("nateraw/vit-age-classifier", num_labels=2)

# Modelin son katmanına Dropout ekleme
